...
// Isolated experiment: test the hypothesis that a Bishop retains more value
// as Omega positions simplify.  Exact endgame WDL does not establish this value.
const int EG_Value[Piece_Size] { 125, 235, 460, 625, 1225, 0, 400, 375 };
