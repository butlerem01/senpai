...
The `omega/exp-phase-wizard-eg395` experiment keeps the Wizard at 375 cp with
all 32 opening-phase units present and tapers it to 395 cp in a fully
simplified position. At 24/16/8 units its integer-interpolated values are
380/385/390 cp. This is an isolated hypothesis for match testing, not a value
proved by an exact tablebase: theoretical WDL classifies positions but does
not measure practical piece strength or a gameplay distribution. The Wizard's
